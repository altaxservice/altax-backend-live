...
export const BUILT_IN: { name: string; category: string; subject: string; english: string; arabic: string }[] = [
  ...
  { name: "Monthly Sales & Bank Statement Request", category: "Requests & Questions", subject: "Monthly documents needed{{periodLabel}}",
    english: "Hello {{clientName}},\n\nTo keep your Sales Tax filing and bookkeeping on schedule, we need two things from you{{periodLabel}}:\n\n1. Your Sales Report — exported from your POS system if you use one, or whatever sales records you keep otherwise.\n2. Your Bank Statement(s) for the same period.\n\nYou're welcome to just reply to this message with them attached. If you already use your client portal, you can upload them there instead.\n\nThis is a routine part of your monthly Sales Tax service with us. If anything about this message looks off or you'd just like to confirm it's really us, call our office directly using the number below — we're always happy to verify.\n\nThank you for helping us keep your books and filings current.\n\nThe AL TAX SERVICE Team",
    arabic: "مرحباً {{clientName}}،\n\nللحفاظ على جدول إقرار ضريبة المبيعات وأعمال المحاسبة الخاصة بكم دون تأخير، نحتاج إلى أمرين منكم{{periodLabelAr}}:\n\n١. تقرير المبيعات — يُصدَّر من نظام نقاط البيع (POS) إن وُجد، أو أي سجلات مبيعات أخرى لديكم.\n٢. كشف/كشوفات الحساب المصرفي لنفس الفترة.\n\nيمكنكم ببساطة الرد على هذه الرسالة وإرفاقها بها. وإذا كنتم تستخدمون بوابة العميل الخاصة بكم، يمكنكم رفعها من هناك بدلاً من ذلك.\n\nهذا طلب روتيني ضمن خدمة ضريبة المبيعات الشهرية معكم. إذا بدت لكم هذه الرسالة غير معتادة أو أردتم التأكد من صحتها، يُرجى الاتصال بمكتبنا مباشرة على الرقم أدناه — يسعدنا دائماً تأكيد ذلك لكم.\n\nشكراً لتعاونكم في إبقاء سجلاتكم وإقراراتكم محدّثة.\n\nفريق AL TAX SERVICE" },

...
export const BUILT_IN: { name: string; category: string; subject: string; english: string; arabic: string }[] = [
  ...
  { name: "Appointment Cancelled", category: "Communications", subject: "Appointment cancelled: {{appointmentTitle}}",
    english: "Hello {{clientName}},\n\nYour appointment \"{{appointmentTitle}}\" on {{appointmentDate}} at {{appointmentTime}} has been cancelled. Please reach out or book a new time if you'd still like to meet.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nتم إلغاء موعدكم \"{{appointmentTitle}}\" بتاريخ {{appointmentDate}} الساعة {{appointmentTime}}. يرجى التواصل معنا أو حجز موعد جديد إذا كنتم ترغبون بذلك.\n\nشكراً لكم." },

...
export const BUILT_IN: { name: string; category: string; subject: string; english: string; arabic: string }[] = [
  { name: "Appointment Confirmation", category: "Communications", subject: "You're confirmed: {{appointmentTitle}}",
    english: "Hi {{clientName}},\n\nThanks for booking with AL TAX SERVICE — you're confirmed for \"{{appointmentTitle}}\" on {{appointmentDate}} at {{appointmentTime}}{{appointmentLocation}}.\n\nWe're looking forward to it. Need a different time instead? Use the link below to reschedule or cancel — no need to call.\n\nTalk soon,\nAL TAX SERVICE",
    arabic: "مرحباً {{clientName}}،\n\nشكراً لحجزكم موعدكم مع AL TAX SERVICE — تم تأكيد موعد \"{{appointmentTitle}}\" بتاريخ {{appointmentDate}} الساعة {{appointmentTime}}{{appointmentLocationAr}}.\n\nنتطلع للحديث معكم. إذا احتجتم لوقت آخر، يمكنكم استخدام الرابط أدناه لإعادة الجدولة أو الإلغاء دون الحاجة للاتصال بنا.\n\nنراكم قريباً،\nAL TAX SERVICE" },
  { name: "Appointment Reminder", category: "Communications", subject: "Reminder: {{appointmentTitle}} is coming up",
    english: "Hi {{clientName}},\n\nJust a friendly reminder — your appointment \"{{appointmentTitle}}\" with AL TAX SERVICE is coming up on {{appointmentDate}} at {{appointmentTime}}{{appointmentLocation}}.\n\nIf your plans changed, you can reschedule or cancel using the link below.\n\nSee you then,\nAL TAX SERVICE",
    arabic: "مرحباً {{clientName}}،\n\nهذا تذكير ودي بموعدكم \"{{appointmentTitle}}\" مع AL TAX SERVICE يوم {{appointmentDate}} الساعة {{appointmentTime}}{{appointmentLocationAr}}.\n\nإذا تغيرت خططكم، يمكنكم إعادة الجدولة أو الإلغاء عبر الرابط أدناه.\n\nنراكم قريباً،\nAL TAX SERVICE" },
  { name: "Appointment Cancelled", category: "Communications", subject: "Cancelled: {{appointmentTitle}}",
    english: "Hi {{clientName}},\n\nYour appointment \"{{appointmentTitle}}\" on {{appointmentDate}} at {{appointmentTime}} has been cancelled.\n\nWhenever you're ready, you're welcome to book a new time on our website, or just reply to this message and we'll help you get back on the calendar.\n\nAL TAX SERVICE",
    arabic: "مرحباً {{clientName}}،\n\nتم إلغاء موعدكم \"{{appointmentTitle}}\" الذي كان مقرراً بتاريخ {{appointmentDate}} الساعة {{appointmentTime}}.\n\nيسعدنا حجز موعد جديد لكم في أي وقت يناسبكم عبر موقعنا الإلكتروني، أو يمكنكم الرد على هذه الرسالة وسنساعدكم على تحديد موعد جديد.\n\nAL TAX SERVICE" },
  ...
  { name: "Missing Information", category: "Communications", subject: "Missing information on your account",
    english: "Hello {{clientName}},\n\nWe reviewed the documents you sent and noticed some information is still missing or unclear. Please reply to this message or contact our office so we can sort out the details together.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nقمنا بمراجعة المستندات التي أرسلتموها ولاحظنا أن بعض المعلومات لا تزال ناقصة أو غير واضحة. يرجى الرد على هذه الرسالة أو التواصل مع مكتبنا لاستكمال التفاصيل معاً.\n\nشكراً لكم." },
  ...
  { name: "Refund Notice", category: "Communications", subject: "Refund update",
    english: "Hello {{clientName}},\n\nWe have an update regarding your refund. Please reply to this message or contact our office for the details.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nلدينا تحديث بخصوص المبلغ المسترد الخاص بكم. يرجى الرد على هذه الرسالة أو التواصل مع مكتبنا للحصول على التفاصيل.\n\nشكراً لكم." },
  { name: "Request Information", category: "Communications", subject: "We need some information from you",
    english: "Hello {{clientName}},\n\nWe need a bit more information from you to move forward. Please reply to this message or call our office at your earliest convenience.\n\nThank you.",
  ...
  { name: "Tax Return Ready for Review", category: "Communications", subject: "Your tax return is ready for review",
    english: "Hello {{clientName}},\n\nYour tax return is ready for review. Please log in to your client portal to review and sign, or reply to this message with any questions.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nإقراركم الضريبي جاهز للمراجعة. يرجى تسجيل الدخول إلى بوابة العميل الخاصة بكم للمراجعة والتوقيع، أو الرد على هذه الرسالة في حال وجود أي استفسارات.\n\nشكراً لكم." },
  { name: "W-9 Request", category: "Communications", subject: "W-9 form needed",
    english: "Hello {{clientName}},\n\nWe need a completed Form W-9 on file for you. Please upload a signed copy through your client portal or reply to this message.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nنحتاج إلى نموذج W-9 موقّع ومكتمل لحفظه في ملفكم. يرجى رفع نسخة موقعة عبر بوابة العميل أو الرد على هذه الرسالة.\n\nشكراً لكم." },
  { name: "Welcome New Client", category: "Communications", subject: "Welcome to AL TAX SERVICE",
    english: "Hello {{clientName}},\n\nWelcome to AL TAX SERVICE! We're glad to have you as a client. You can access your documents, invoices, and messages anytime through your client portal. Let us know if you have any questions as we get started.\n\nThank you.",
    arabic: "مرحباً {{clientName}}،\n\nنرحب بكم في AL TAX SERVICE! يسعدنا انضمامكم كعميل لدينا. يمكنكم الوصول إلى مستنداتكم وفواتيركم ورسائلكم في أي وقت عبر بوابة العميل الخاصة بكم. يرجى إعلامنا إذا كان لديكم أي استفسارات ونحن نبدأ معاً.\n\nشكراً لكم." },
];

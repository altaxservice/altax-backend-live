...
import { dailyLogRouter } from "./modules/dailyLog/dailyLog.routes";
...
app.use("/public/kiosk", publicKioskRouter);
...
app.use("/staff-notes", staffNotesRouter);
app.use("/daily-log", dailyLogRouter);

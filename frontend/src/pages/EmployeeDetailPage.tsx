        ...
        <div className="card" style={{ maxWidth: 560 }}>
          ...
          {isAdmin && editingSensitive && (
            <form onSubmit={handleSaveSensitive}>
              ...
              <div className="field"><label htmlFor="emp-sensitive-bank-name">Bank Name</label><input id="emp-sensitive-bank-name" autoComplete="off" data-no-suggest value={sensitiveForm.paymentBankName} onChange={(e) => setSensitiveForm((f) => ({ ...f, paymentBankName: e.target.value }))} /></div>
              <div className="field"><label htmlFor="emp-sensitive-routing-number">Routing Number</label><input id="emp-sensitive-routing-number" autoComplete="off" data-no-suggest value={sensitiveForm.paymentRoutingNumber} onChange={(e) => setSensitiveForm((f) => ({ ...f, paymentRoutingNumber: e.target.value }))} placeholder="Leave blank to keep current" /></div>
              <div className="field"><label htmlFor="emp-sensitive-account-number">Account Number</label><input id="emp-sensitive-account-number" autoComplete="off" data-no-suggest value={sensitiveForm.paymentAccountNumber} onChange={(e) => setSensitiveForm((f) => ({ ...f, paymentAccountNumber: e.target.value }))} placeholder="Leave blank to keep current" /></div>

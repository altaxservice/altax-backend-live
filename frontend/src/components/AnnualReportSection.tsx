                        ...
                        <tr>
                          <td colSpan={4} style={{ background: "var(--surface-2, #f8fafb)", padding: 16 }}>
                            {y.existingFiling ? (
                              <div className="table-scroll">
                                <table>
                                  <thead><tr><th>Year</th><th>Filed</th><th style={{ textAlign: "right" }}>Amount</th><th>Payment</th>{showClientColumn && <th>Client</th>}<th></th></tr></thead>
              ...
              <table>
                ...
                <tbody>
                  ...
                  {history && !history.length && (
                    <tr><td colSpan={showClientColumn ? 6 : 5} className="muted" style={{ textAlign: "center", padding: 20 }}>No Annual Report filings recorded yet.</td></tr>
                  )}
                </tbody>
              </table>
            </div>

...
export function SendSubscriptionBrochureModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div ref={panelRef} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="send-brochure-title" style={{ width: "min(880px, 94vw)" }} onClick={(e) => e.stopPropagation()}>
